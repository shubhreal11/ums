...
class Person {
 ...
 constructor(fName , age) {
   ...
   introduceSelf() {
   console.log(`Person-->! I'm ${this.name} and my age is ${this.age}`);
   }
...
class Professor extends Person {
 ...
 introduceSelf() {
   console.log(`Professor-->! teaches  ${this.teaches} to ${this.name} `);
 }
...
let obj = new Person('Shubham',25);
obj.introduceSelf()

let obj1 = new Professor('Mr. Gupta','CPP');
obj1.introduceSelf()
